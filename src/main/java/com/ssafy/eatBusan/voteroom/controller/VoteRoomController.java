...
public class VoteRoomController {
    ...
    // 방 생성: 호스트 위치 기반 후보 시드 + memberId 리스트 초대
    @PostMapping
    ...
    // 투표/표 변경: 같은 후보 재클릭은 멱등이므로 200으로 일괄 처리
    ...
    public ResponseEntity<VoteResponse> vote(
        ...
        return ResponseEntity.ok(voteService.cast(publicId, loginMember.id(), request.candidateId()));
    }
