...
public record TallyUpdatedMessage(String type, long version, List<TallyEntry> tally) {

    public static TallyUpdatedMessage of(long version, List<TallyEntry> tally) {
        return new TallyUpdatedMessage("TALLY_UPDATED", version, tally);
    }
}
